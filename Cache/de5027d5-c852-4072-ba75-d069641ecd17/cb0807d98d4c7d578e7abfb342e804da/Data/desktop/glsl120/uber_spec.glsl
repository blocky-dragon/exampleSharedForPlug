...
#endif
vec3 l9_25=(l9_21.xyz*1.99219)+vec3(-1.0,-1.0,0.0);
...
#endif
vec4 l9_42=sc_SampleTextureBiasOrLevel(reflectionTexDims.xy,reflectionTexLayout,l9_41,vec2(0.5)-(l9_34.xy/vec2(l9_40)),(int(SC_USE_UV_TRANSFORM_reflectionTex)!=0),reflectionTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_reflectionTex,SC_SOFTWARE_WRAP_MODE_V_reflectionTex),(int(SC_USE_UV_MIN_MAX_reflectionTex)!=0),reflectionTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_reflectionTex)!=0),reflectionTexBorderColor,0.0,reflectionTex);
...
l9_47=ssSRGB_to_Linear(l9_49)*l9_56;
}
#else
{
l9_47=vec3(0.0);
...
#endif
vec3 l9_57=ssPow((l9_31+l9_32)+l9_47,vec3(0.454545));
vec3 l9_58;
...
{
vec3 l9_66=mix(vec3(0.04),l9_16.xyz*l9_59,vec3(l9_59));
...
{
if (l9_69<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)*0.0588235))
{
discard;
}
}
...
vec3 l9_74=clamp(l9_67,vec3(0.0),vec3(1.0));
vec3 l9_75=ssSRGB_to_Linear(l9_70);
vec3 l9_76=normalize(l9_68);
vec3 l9_77=ssSRGB_to_Linear(max(l9_57,vec3(0.0)));
vec3 l9_78;
#if (sc_SSAOEnabled)
{
...
#endif
vec3 l9_79=vec3(l9_72);
vec3 l9_80=mix(vec3(0.04),l9_75*l9_72,l9_79);
vec3 l9_81=mix(l9_75*(1.0-l9_72),vec3(0.0),l9_79);
SurfaceProperties l9_82=SurfaceProperties(l9_81,l9_69,l9_76,varPos,l9_6,l9_72,l9_73,l9_77,l9_78,l9_74,vec3(1.0),l9_80);
vec4 l9_83=vec4(1.0);
vec3 l9_84;
vec3 l9_85;
vec3 l9_86;
...
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_119<sc_PointLightsCount)
{
vec3 l9_121=sc_PointLights[l9_119].position-varPos;
vec3 l9_122=normalize(l9_121);
float l9_123=l9_83[(l9_120<3) ? l9_120 : 3];
float l9_124=clamp((dot(l9_122,sc_PointLights[l9_119].direction)*sc_PointLights[l9_119].angleScale)+sc_PointLights[l9_119].angleOffset,0.0,1.0);
float l9_125=(sc_PointLights[l9_119].color.w*l9_123)*(l9_124*l9_124);
float l9_126;
if (sc_PointLights[l9_119].falloffEnabled)
{
l9_126=l9_125*computeDistanceAttenuation(length(l9_121),sc_PointLights[l9_119].falloffEndDistance);
}
else
{
l9_126=l9_125;
...
l9_112=l9_120+1;
LightingComponents l9_127=accumulateLight(LightingComponents(l9_106,l9_107,l9_111,l9_110,l9_109,l9_108),LightProperties(l9_122,sc_PointLights[l9_119].color.xyz,l9_126),l9_82,l9_6);
l9_113=l9_127.directDiffuse;
l9_114=l9_127.directSpecular;
l9_115=l9_127.indirectDiffuse;
l9_116=l9_127.indirectSpecular;
l9_117=l9_127.emitted;
l9_118=l9_127.transmitted;
l9_111=l9_115;
l9_110=l9_116;
l9_120=l9_112;
l9_109=l9_117;
...
{
vec3 l9_133=getSpecularDominantDir(l9_76,reflect(-l9_6,l9_76),l9_73);
float l9_134=clamp(pow(l9_73,0.666667),0.0,1.0)*5.0;
float l9_135=-l9_133.z;
float l9_136=l9_133.x;
vec2 l9_137=vec2(0.0);
l9_137.x=(((l9_136<0.0) ? (-1.0) : 1.0)*acos(clamp(l9_135/length(vec2(l9_136,l9_135)),-1.0,1.0)))-1.5708;
vec2 l9_138=l9_137;
l9_138.y=acos(l9_133.y);
vec2 l9_139=l9_138*vec2(0.159155,0.31831);
vec2 l9_140=l9_139;
l9_140.y=1.0-l9_139.y;
float l9_141=l9_139.x+(sc_EnvmapRotation.y*0.00277778);
vec2 l9_142=l9_140;
l9_142.x=fract((l9_141+floor(l9_141))+1.0);
vec4 l9_143;
#if ((SC_DEVICE_CLASS>=2)&&SC_GL_FRAGMENT_PRECISION_HIGH)
{
float l9_144=floor(l9_134);
float l9_145=ceil(l9_134);
l9_143=mix(sc_EnvmapSpecularSampleViewIndexLevel(calcSeamlessPanoramicUvsForSampling(l9_142,sc_EnvmapSpecularSize.xy,l9_144),sc_EnvmapSpecularGetStereoViewIndex(),l9_144),sc_EnvmapSpecularSampleViewIndexLevel(calcSeamlessPanoramicUvsForSampling(l9_142,sc_EnvmapSpecularSize.xy,l9_145),sc_EnvmapSpecularGetStereoViewIndex(),l9_145),vec4(l9_134-l9_144));
}
#else
{
l9_143=sc_EnvmapSpecularSampleViewIndexLevel(l9_142,sc_EnvmapSpecularGetStereoViewIndex(),l9_134);
}
#endif
l9_132=(((l9_143.xyz*(1.0/l9_143.w))*sc_EnvmapExposure)+vec3(1e-06))*envBRDFApprox(l9_82,abs(dot(l9_76,l9_6)));
}
#else
{
l9_132=vec3(0.0);
...
{
float l9_147=clamp(l9_73*l9_73,0.01,1.0);
vec3 l9_148;
l9_148=sc_LightEstimationData.ambientLight*l9_80;
int l9_149=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_149<sc_LightEstimationSGCount)
{
float l9_150=l9_147*l9_147;
vec3 l9_151=reflect(-l9_6,l9_76);
float l9_152=dot(l9_76,l9_6);
float l9_153=(2.0/l9_150)/(4.0*max(l9_152,0.0001));
float l9_154=length((l9_151*l9_153)+(sc_LightEstimationData.sg[l9_149].axis*sc_LightEstimationData.sg[l9_149].sharpness));
float l9_155=clamp(dot(l9_76,l9_151),0.0,1.0);
float l9_156=clamp(l9_152,0.0,1.0);
float l9_157=1.0-l9_150;
l9_148+=((((((((vec3(0.31831/l9_150)*exp((l9_154-l9_153)-sc_LightEstimationData.sg[l9_149].sharpness))*sc_LightEstimationData.sg[l9_149].color)*6.28319)*(1.0-exp((-2.0)*l9_154)))/vec3(l9_154))*((1.0/(l9_155+sqrt(l9_150+((l9_157*l9_155)*l9_155))))*(1.0/(l9_156+sqrt(l9_150+((l9_157*l9_156)*l9_156))))))*(l9_80+((vec3(1.0)-l9_80)*pow(1.0-clamp(dot(l9_151,normalize(l9_151+l9_6)),0.0,1.0),5.0))))*l9_155);
l9_149++;
continue;
}
else
...
{
l9_159=ssSRGB_to_Linear(sc_GetFramebufferColor().xyz)*mix(vec3(1.0),l9_81,vec3(l9_69));
l9_158=1.0;
}
#else
{
...
#endif
vec3 l9_161=l9_146*l9_74;
vec3 l9_162=l9_128+l9_161;
if (l9_160)
{
}
vec3 l9_163=(l9_162+l9_77)+l9_159;
float l9_164=l9_163.x;
vec4 l9_165=vec4(l9_164,l9_163.yz,l9_158);
vec4 l9_166;
#if (sc_IsEditor)
{
vec4 l9_167=l9_165;
l9_167.x=l9_164+((l9_78.x*l9_74.x)*1e-05);
l9_166=l9_167;
}
#else
{
...
{
vec3 l9_169=linearToneMapping(l9_166.xyz);
l9_168=vec4(l9_169.x,l9_169.y,l9_169.z,l9_166.w);
}
#else
{
l9_168=l9_166;
...
#endif
vec3 l9_170=vec3(linearToSrgb(l9_168.x),linearToSrgb(l9_168.y),linearToSrgb(l9_168.z));
l9_71=vec4(l9_170.x,l9_170.y,l9_170.z,l9_168.w);
}
#else
{
...
#endif
vec4 l9_171=max(l9_71,vec4(0.0));
vec4 l9_172;
#if (sc_ProjectiveShadowsCaster)
{
float l9_173;
...
#if (sc_BlendMode_Multiply)
{
l9_177=(1.0-dot(l9_171.xyz,vec3(0.33333)))*l9_171.w;
}
#else
{
float l9_178;
...
{
l9_182=dot(l9_171.xyz,vec3(0.33333))*l9_171.w;
}
#else
{
float l9_183;
...
{
l9_197=vec4(shaderComplexityValue*0.00392157,0.0,0.0,1.0);
}
#else
{
l9_197=vec4(0.0);
...
vec4 l9_199=max(l9_198,vec4(0.0));
...
#if (sc_OITDepthBoundsPass)
{
float l9_201=clamp(viewSpaceDepth()*0.001,0.0,1.0);
sc_writeFragData0(vec4(max(0.0,1.00392-l9_201),min(1.0,l9_201+0.00392157),0.0,0.0));
}
#endif
}
#else
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_202=sc_ScreenCoordsGlobalToView(l9_5);
...
vec4 l9_205=vec4(0.0);
l9_205.x=l9_204;
vec4 l9_207=l9_205;
l9_207.y=packValue(l9_203);
vec4 l9_209=l9_207;
l9_209.z=packValue(l9_203);
vec4 l9_211=l9_209;
l9_211.w=packValue(l9_203);
vec4 l9_213=vec4(0.0);
l9_213.x=packValue(l9_203);
vec4 l9_215=l9_213;
l9_215.y=packValue(l9_203);
vec4 l9_217=l9_215;
l9_217.z=packValue(l9_203);
vec4 l9_218=l9_217;
l9_218.w=packValue(l9_203);
int l9_219=int(l9_200.w*255.0);
float l9_220=packValue(l9_219);
vec4 l9_221=vec4(0.0);
l9_221.x=l9_220;
vec4 l9_223=l9_221;
l9_223.y=packValue(l9_219);
vec4 l9_225=l9_223;
l9_225.z=packValue(l9_219);
vec4 l9_226=l9_225;
l9_226.w=packValue(l9_219);
sc_writeFragData0(l9_218);
sc_writeFragData1(l9_211);
sc_writeFragData2(l9_226);
...
#if (sc_OITCompositingPass)
{
vec2 l9_227=sc_ScreenCoordsGlobalToView(l9_5);
#if (sc_OITMaxLayers4Plus1)
{
...
if (l9_238==0)
{
l9_241=texture2D(sc_OITAlpha0,l9_227);
l9_240=texture2D(sc_OITDepthLow0,l9_227);
l9_239=texture2D(sc_OITDepthHigh0,l9_227);
}
else
{
l9_241=l9_234;
...
if (l9_238==1)
{
l9_237=texture2D(sc_OITAlpha1,l9_227);
l9_236=texture2D(sc_OITDepthLow1,l9_227);
l9_235=texture2D(sc_OITDepthHigh1,l9_227);
}
else
{
l9_237=l9_241;
...
if (any(notEqual(l9_235,vec4(0.0)))||any(notEqual(l9_236,vec4(0.0))))
{
int l9_242[8]=l9_228;
unpackValues(l9_235.w,l9_238,l9_242);
unpackValues(l9_235.z,l9_238,l9_242);
unpackValues(l9_235.y,l9_238,l9_242);
unpackValues(l9_235.x,l9_238,l9_242);
unpackValues(l9_236.w,l9_238,l9_242);
unpackValues(l9_236.z,l9_238,l9_242);
unpackValues(l9_236.y,l9_238,l9_242);
unpackValues(l9_236.x,l9_238,l9_242);
int l9_251[8]=l9_229;
unpackValues(l9_237.w,l9_238,l9_251);
unpackValues(l9_237.z,l9_238,l9_251);
unpackValues(l9_237.y,l9_238,l9_251);
unpackValues(l9_237.x,l9_238,l9_251);
}
l9_234=l9_237;
l9_233=l9_236;
l9_232=l9_235;
...
vec4 l9_256=texture2D(sc_OITFilteredDepthBoundsTexture,l9_227);
vec2 l9_257=l9_256.xy;
int l9_258;
#if (sc_SkinBonesCount>0)
{
l9_258=encodeDepth(((1.0-l9_256.x)*1000.0)+getDepthOrderingEpsilon(),l9_257);
}
#else
{
l9_258=0;
...
#endif
int l9_259=encodeDepth(viewSpaceDepth(),l9_257);
vec4 l9_260;
l9_260=l9_200*l9_200.w;
vec4 l9_261;
int l9_262=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_262<8)
{
int l9_263=l9_228[l9_262];
int l9_264=l9_259-l9_258;
bool l9_265=l9_263<l9_264;
bool l9_266;
if (l9_265)
{
l9_266=l9_228[l9_262]>0;
}
else
{
l9_266=l9_265;
...
if (l9_266)
{
vec3 l9_267=l9_260.xyz*(1.0-(float(l9_229[l9_262])*0.00392157));
l9_261=vec4(l9_267.x,l9_267.y,l9_267.z,l9_260.w);
}
else
{
l9_261=l9_260;
